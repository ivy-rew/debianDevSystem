...
echo 'alias vncHome="vncserver -localhost no -name home -geometry 1366x768 -xstartup $HOME/.vnc/anonymous-vnc_xstartup  :1"' >> ~/.bash_aliases
echo 'alias vncHomeKill="vncserver -kill :1"' >> ~/.bash_aliases
source ~/.bash_aliases
